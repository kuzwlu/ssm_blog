  ...
  <body>
	...
	<table width="99%" border="0" cellspacing="0" cellpadding="0" id="main">
	  <tr>
	    ...
	    <div class="top"><span class="left">您上次的登灵时间：${cookie.lastAccess.value} &nbsp;&nbsp; 登录IP：192.168.123.1&nbsp;&nbsp;&nbsp;&nbsp;如非您本人操作，请及时</span><a href="manager/list/1" target="mainFrame" onFocus="this.blur()" style="color: #528dc5;">&nbsp;更改密码</a></div>
