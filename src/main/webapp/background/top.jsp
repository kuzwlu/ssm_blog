	    ...
	    <table width="100%" border="0" cellspacing="0" cellpadding="0">
	      <tr>
	        ...
	        <td align="right" valign="top" id="header-right">
	        	...
	        	<a href="index/1" target="_blank" onFocus="this.blur()" class="admin-index">网站首页</a>       	
	            <span>
	<!-- 日历 -->
	  ...
	  <tr>
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
	      <tr>
	        ...
	        <a href="manager/list/${1}" target="mainFrame" onFocus="this.blur()" id="m2">用户管理</a>
	        <a href="catalog/list/${1 }" target="mainFrame" onFocus="this.blur()" id="m3">栏目管理</a>
	        <a href="article/list/${1 }" target="mainFrame" onFocus="this.blur()" id="m5">文章管理</a>
	        <a target="mainFrame" onFocus="this.blur()" id="m5">留言管理</a>
	        <a target="mainFrame" onFocus="this.blur()" id="m6">附件管理</a>
	        <a target="mainFrame" onFocus="this.blur()" id="m7">站点管理</a>
	        </td>
	      </tr>
	    </table></td>
	  </tr>
