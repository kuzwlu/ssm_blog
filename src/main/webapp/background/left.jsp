	...
	<div id="left-top">
	    ...
	    <div style="float: left" id="my_menu" class="sdmenu">
	      <div class="collapsed">
	        ...
	        <a href="manager/list/1" target="mainFrame" onFocus="this.blur()">管理员列表</a>
	        <a href="background/main_info.jsp" target="mainFrame" onFocus="this.blur()">添加管理员</a>
	      </div>
	      <div>
	        <span>栏目设置</span>

	        <a href="catalog/list/1" target="mainFrame" onFocus="this.blur()">栏目列表</a>
	        <a href="catalog/catalog_info" target="mainFrame" onFocus="this.blur()">添加栏目</a>
	      </div>
	      
	      <div>
	        <span>文章设置</span>
	        <a href="article/list/1" target="mainFrame" onFocus="this.blur()">文章列表</a>
	        <a href="article/article_info" target="mainFrame" onFocus="this.blur()">添加文章</a>
	      </div>
