...
<html>
  <head>
	...
	$(function(){
		...
		$("#code").click(function () {
	            $(this).prop("src", "code?" + new Date().getTime());
	     });
	     $("#code").prop("src", "code?" + new Date().getTime());
	  })
	</script>
	            ...
	            <li class="topD">
	                <ul class="login">
	                    <li><span class="left login-text">用户名：</span> <span style="left">
	                        <input id="Text1" type="text" class="txt" name="managername"/>  
	                    ...
	                    <li style="position:absolute;width: 250px;"><span class="left login-text">验证码：</span> <span style="left">
	                       	<input id="codeinput" type="text" class="txt" name="code" style="width:80px;" onchange="a1()"/><span id="pspan"> </span>
	                       	<img id="code" style="position: relative;top: 6px;left:10px;">
	                    </span></li>
