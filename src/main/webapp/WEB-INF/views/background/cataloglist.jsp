	...
	<table width="99%" border="0" cellspacing="0" cellpadding="0" id="searchmain">
	  ...
	  <tr>
	    ...
	    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="search">
	  		<tr>
	  		  ...
	  		  <a href="catalog/catalog_info" target="mainFrame" onFocus="this.blur()" class="add">新增栏目</a></td>
	  		</tr>
		</table>
	    </td>
	  </tr>
	  <tr>
	    ...
	    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
	      ...
	      <c:forEach items="${requestScope.catalogList}" var="p">
	        ...
	        <td align="center" valign="middle" class="borderbottom">
	        	<a href="catalog/catalog_update/${p.caid }" target="mainFrame" onFocus="this.blur()" class="add">编辑</a>
	        	
	        	<span class="gray">&nbsp;|&nbsp;</span>
	        	<a href="catalog/exchange/${p.canumber }"  target="mainFrame" onFocus="this.blur()" class="add" />上移</a>
	        	<span class="gray">&nbsp;|&nbsp;</span>
	  ...
	  <tr>
	    ...
	    <a href="catalog/list/1" target="mainFrame" onFocus="this.blur()">首页</a>&nbsp;&nbsp;
	    <c:choose>
	    	<c:when test="${requestScope.startPage ==1 }">
	    		<a href="catalog/list/1" target="mainFrame" onFocus="this.blur()">上一页</a>&nbsp;&nbsp;
	    	</c:when>
	    	<c:otherwise>
	    		<a href="catalog/list/${requestScope.startPage - 1 }" target="mainFrame" onFocus="this.blur()">上一页</a>&nbsp;&nbsp;
	    	</c:otherwise>
	    </c:choose>
	    <c:choose>
	    	<c:when test="${requestScope.startPage >= lastPage }">
	    		<a href="catalog/list/${requestScope.startPage}" target="mainFrame" onFocus="this.blur()">下一页</a>&nbsp;&nbsp;
	    	</c:when>
	    	<c:otherwise>
	    		<a href="catalog/list/${requestScope.startPage + 1 }" target="mainFrame" onFocus="this.blur()">下一页</a>&nbsp;&nbsp;
	    	</c:otherwise>
	    </c:choose>
	    <a href="catalog/list/${requestScope.lastPage}" target="mainFrame" onFocus="this.blur()">尾页</a></td>
	  </tr>
	  ...
	  function del(id,canumber){
			swal({
				...
				if (isConfirm === true) {
					//window.location.href='catalog/delete/'+id+'/'+canumber;
					swal(
					  '删除失败',
					  '不可删除',
					  'error'
