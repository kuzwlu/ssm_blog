  ...
  <script type="text/javascript">
	...
	<table width="99%" border="0" cellspacing="0" cellpadding="0" id="searchmain">
	  ...
	  <tr>
	    ...
	    <a target="mainFrame" onFocus="this.blur()">修改管理员</a>
	    </td>
	  </tr>
	  <tr>
	    ...
	    <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'" hidden="hidden">
	        ...
	        <td align="left" valign="middle" class="borderright borderbottom main-for">${requestScope.managerList.managerid }</td>
	        </tr>
	    	<tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
	        <td align="right" valign="middle" class="borderright borderbottom bggray">管理员名：</td>
	        <td align="left" valign="middle" class="borderright borderbottom main-for">
			<input type="text" name="managername" value="${requestScope.managerList.managername }" class="text-word" readonly="readonly">
			</td>
	        </tr>
	      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
	        <td align="right" valign="middle" class="borderright borderbottom bggray">新的密码：</td>
	        <td align="left" valign="middle" class="borderright borderbottom main-for">
	        <input type="text" name="passwd" value="" class="text-word" onkeyup="value=value.replace(/[\u4e00-\u9fa5]/ig,'')" id="pwdId" onblur="a2()" onchange="a3()">
	        </td>
	        </tr>
	      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
	        <td align="right" valign="middle" class="borderright borderbottom bggray">确认密码：</td>
	        <td align="left" valign="middle" class="borderright borderbottom main-for">
	        <input type="text" name="passwd2" value="" class="text-word" onkeyup="value=value.replace(/[\u4e00-\u9fa5]/ig,'')"id="pwd2Id" onblur="a1()"><span id="pspan"></span>
	        </td>
	      </tr>
	      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
	        <td align="right" valign="middle" class="borderright borderbottom bggray">用户状态：</td>
	        <td align="left" valign="middle" class="borderright borderbottom main-for">
	        <select name="matate" id="level">
	        	<c:if test="${requestScope.managerList.matate eq '1'}">
		        	<option value="1" selected="selected">&nbsp;&nbsp;启用</option>
		        	<option value="2" >&nbsp;&nbsp;未启用</option>
	        	</c:if>
		    	<c:if test="${requestScope.managerList.matate eq '2'}">
	      ...
	      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
	        ...
	        <td align="left" valign="middle" class="borderright borderbottom main-for">
	        <input name="managerid" value="${requestScope.managerList.managerid }" type="hidden">
