  ...
  <body>
	...
	<table width="99%" border="0" cellspacing="0" cellpadding="0" id="searchmain">
	  ...
	  <tr>
	    ...
	    <a href="manager/list/1" target="mainFrame" onFocus="this.blur()">首页</a>&nbsp;&nbsp;
	    <c:choose>
	    	<c:when test="${requestScope.startPage ==1 }">
	    		<a href="manager/list/1" target="mainFrame" onFocus="this.blur()">上一页</a>&nbsp;&nbsp;
	    	</c:when>
	    	<c:otherwise>
	    		<a href="manager/list/${requestScope.startPage - 1 }" target="mainFrame" onFocus="this.blur()">上一页</a>&nbsp;&nbsp;
	    	</c:otherwise>
	    </c:choose>
	    <c:choose>
	    	<c:when test="${requestScope.startPage >= lastPage }">
	    		<a href="manager/list/${requestScope.startPage}" target="mainFrame" onFocus="this.blur()">下一页</a>&nbsp;&nbsp;
	    	</c:when>
	    	<c:otherwise>
	    		<a href="manager/list/${requestScope.startPage + 1 }" target="mainFrame" onFocus="this.blur()">下一页</a>&nbsp;&nbsp;
	    	</c:otherwise>
	    </c:choose>
	    <a href="manager/list/${requestScope.lastPage}" target="mainFrame" onFocus="this.blur()">尾页</a></td>
	  </tr>
	</table>  
