  ...
  <body>
	...
	<table width="99%" border="0" cellspacing="0" cellpadding="0" id="searchmain">
	  ...
	  <tr>
	    ...
	    <a target="mainFrame" onFocus="this.blur()" class="add">编辑文章</a>
	    </td>
	  </tr>
	  <tr>
	    ...
	    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
	      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
	        ...
	        <option value="${requestScope.articleList.caid }" >&nbsp;&nbsp;${ requestScope.caname}</option>
	        <c:forEach items="${requestScope.catalogList}" var="c">
		        <c:if test="${requestScope.articleList.caid != c.caid }">
	      ...
	      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
	        ...
	        <td align="left" valign="middle" class="borderright borderbottom main-for"><script id="container" name="arcontent"  type="text/plain" style="width:700px;height:350px;">	${requestScope.articleList.arcontent}</script>
	        </td>
	      </tr>
	      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
	       ...
	       <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
	        ...
	        <input type="file" name="file" style="top: 40%;position: absolute;" accept="image/gif,image/jpeg,image/jpg,image/png,image/svg"/>
	        <div id="qq"><span style="font-size: 14px;" id="theman">图片：</span><img src="upload/article/${requestScope.articleList.arimage}" id="imagepath">
	        <a href="article/down?filename=${requestScope.articleList.arimage }" ><span id="thewoman">下载这张图片</span></a></div>
	        </td>
	        </tr>
	      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
