			...
			<div class="auto">
				<div class="main" id="main">
					...
					<div class="main-post post-box card">
						<div class="subimg">
							<a href="#">
								...
								<img src="../upload/article/${requestScope.articles[0].arimage }" onerror="whenError(this)" />
							</a>
						</div>
						<div class="title">
							<a href="list/${requestScope.articles[0].arid}" >${requestScope.articles[0].artitle }</a>
						</div>
					...
					<div class="main-post post-box card">
						<div class="subimg">
							<a href="#">
								<img src="../upload/article/${requestScope.articles[1].arimage }" onerror="whenError(this)" />
							</a>
						</div>
						<div class="title">
							<a href="list/${requestScope.articles[1].arid}" >${requestScope.articles[1].artitle }</a>
						</div>
						<div class="main-content">
					...
					<div class="main-post post-box card">
						<div class="subimg">
							<a href="#">
								<img src="../upload/article/${requestScope.articles[2].arimage }" onerror="whenError(this)" />
							</a>
						</div>
						<div class="title">
							<a href="list/${requestScope.articles[2].arid}">${requestScope.articles[2].artitle }</a>
						</div>
						<div class="main-content">
					...
					<div class="main-post post-box card">
						<div class="subimg">
							<a href="#">
								<img src="../upload/article/${requestScope.articles[3].arimage }" onerror="whenError(this)" />
							</a>
						</div>
						<div class="title">
							<a href="list/${requestScope.articles[3].arid}" >${requestScope.articles[3].artitle }</a>
						</div>
						<div class="main-content">
					...
					<div class="main-post post-box card">
						<div class="subimg">
							<a href="#">
								<img src="../upload/article/${requestScope.articles[4].arimage }" onerror="whenError(this)" />
							</a>
						</div>
						<div class="title">
							<a href="list/${requestScope.articles[4].arid}" >${requestScope.articles[4].artitle }</a>
						</div>
						<div class="main-content">
					 ...
					 <span id="thepage" >
					  	...
					  	<p id="pageone">${requestScope.page }/${requestScope.lastPage } 页</p>
					  	<p id="pagetwo" style="margin: 20px 20px 40px 20px;">
					  	<a href="1" style="color: #7ea5de;">首页</a>&nbsp;&nbsp;
					  	<c:choose>
					    	<c:when test="${requestScope.startPage ==1 }">
					    		<a href="1" target="mainFrame" style="color: #7ea5de;">上一页</a>&nbsp;&nbsp;
					    	</c:when>
					    	<c:otherwise>
					    		<a href="${requestScope.startPage - 1 }" style="color: #7ea5de;">上一页</a>&nbsp;&nbsp;
					    	</c:otherwise>
					    </c:choose>
					    <c:choose>
					    	<c:when test="${requestScope.startPage >= lastPage }">
					    		<a href="${requestScope.startPage}" style="color: #7ea5de;">下一页</a>&nbsp;&nbsp;
					    	</c:when>
					    	<c:otherwise>
					    		<a href="${requestScope.startPage + 1 }" style="color: #7ea5de;">下一页</a>&nbsp;&nbsp;
					    	</c:otherwise>
					    </c:choose>
						...
						<!-- <a onclick="next('${requestScope.maxpage }')" onFocus="this.blur()" style="color: #7ea5de;" >下一页</a>&nbsp;&nbsp; -->
					  	<a href="${requestScope.lastPage }" onFocus="this.blur()" style="color: #7ea5de;">尾页</a>&nbsp;&nbsp;
					  	</p>
					  	</span> 
					  </span>
				</div>
